                ...
                <div className="absolute p-4 w-full max-h-full">
                    ...
                    <div className=" max-w-2xl bg-white rounded-lg mx-auto mt-10 shadow dark:bg-gray-700">
                        ...
                        <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button onClick={handleSubmit} type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit and go to Seat Editor</button>
